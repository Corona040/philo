...
/*   Updated: 2024/04/29 15:06:35 by ecorona-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	// MONITOR DEATHS
	monitor(philos, &print, &can_print);
...
void	*routine(void *arg)
{
	...
	while (1)
	{
		pthread_mutex_lock(philo->grab);
		get_forks(philo);
		pthread_mutex_unlock(philo->grab);
		p_eat(philo);
